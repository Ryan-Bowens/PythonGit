class BankAccount:
    ...
    def display_account_info(self):
        print(f"Your Balance: {self.balance}, Your Interest: {self.interest}")
        return self
    
ba1 = BankAccount(0.02, 100)
ba2 = BankAccount(0.02, 200)

ba1.display_account_info().deposit(50).deposit(50).deposit(50).withdraw(100).yield_interest().display_account_info()
print("----------")
